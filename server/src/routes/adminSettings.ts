...
adminSettings.get('/admin/feature-overrides', async (c) => {
  ...
  const flags: FeatureFlag[] = ['ai', 'retrospective', 'calendar', 'auth_password', 'auth_google', 'auth_github', 'github_integration', 'gitlab_integration']
...
adminSettings.patch('/admin/feature-overrides/:flag', async (c) => {
  ...
  const knownFlags: FeatureFlag[] = ['ai', 'retrospective', 'calendar', 'auth_password', 'auth_google', 'auth_github', 'github_integration', 'gitlab_integration']

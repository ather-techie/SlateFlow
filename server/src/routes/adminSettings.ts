...
adminSettings.get('/admin/feature-overrides', async (c) => {
  ...
  const flags: FeatureFlag[] = ['ai', 'auto_test_case_generation_ai', 'auto_story_generation_ai', 'retrospective', 'calendar', 'auth_password', 'auth_google', 'auth_github', 'github_integration', 'gitlab_integration', 'email_notifications', 'card_attachments']
...
adminSettings.patch('/admin/feature-overrides/:flag', async (c) => {
  ...
  const knownFlags: FeatureFlag[] = ['ai', 'auto_test_case_generation_ai', 'auto_story_generation_ai', 'retrospective', 'calendar', 'auth_password', 'auth_google', 'auth_github', 'github_integration', 'gitlab_integration', 'email_notifications', 'card_attachments']

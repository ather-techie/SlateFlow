// OpenAPI 3.0 spec entries for the test case management API.
// Serve via GET /api/openapi.json (mounted in index.ts).

export const testCaseOpenApi = {
  openapi: '3.0.3',
  info: { title: 'SlateFlow – Test Case Management', version: '1.0.0' },
  tags: [

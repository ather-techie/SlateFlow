...
- **Comprehensive test suite** — unit tests for components, hooks, and stores using Vitest + React Testing Library; run with `npm run test` or watch mode with `npm run test:watch`
